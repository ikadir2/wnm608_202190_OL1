...
<body style="margin:0; padding:0;">
	...
	<div class="landing-page">
		...
		<div class="hero-content">
			<h1 style="color:#fff; font-size: 80px; line-height: 100px;">
	...
	<div class="page-cart-content" style="margin-bottom: 120px;">
		<h1 style="display: flex; justify-content: center; margin-top: -250px; margin-bottom: 50px; color: #008374;">Small Actions, Big Impact</h1>
		<div class="grid gap" style="display: flex; justify-content: center; flex-wrap: wrap;">
			<div class="col-xs-12 col-md-3">
				<figure class="figure product" style="width: 400px; text-align: center; padding-bottom: 20px;">
					<div class="image-wrapper">
				      <img src="img/ob1.jpg" alt="" style="width:400px; height:400px">
				    </div>
				    <h1 style="font-size:20px; color: #FF7506">Save Money. Save Food.</h1>
					<p style="color: #6D7473; padding: 0 15px 0 15px">Rescue good food with minor flaws or near expiry. Save money & cut waste.</p>
				</figure>
			</div>
			...
			<div class="col-xs-12 col-md-3">
				<figure class="figure product" style="width: 400px; text-align: center; padding-bottom: 20px;">
					<div class="image-wrapper">
				      <img src="img/ob2.jpg" alt="" style="width:400px; height:400px">
				    </div>
				    <h1 style="font-size:20px; color: #FF7506">Freshness Guaranteed</h1>
					<p style="color: #6D7473; padding: 0 15px 0 15px">We partner with stores to rescue fresh, safe food from waste daily.</p>
				</figure>
			</div>
			...
			<div class="col-xs-12 col-md-3">
				<figure class="figure product" style="width: 400px; text-align: center; padding-bottom: 20px;">
					<div class="image-wrapper">
				      <img src="img/ob3.jpg" alt="" style="width:400px; height:400px">
				    </div>
				    <h1 style="font-size:20px; color: #FF7506">Earn and Redeem</h1>
					<p style="color: #6D7473; padding: 0 15px 0 15px">Earn points with every rescue and redeem them for rewards.</p>
				</figure>
			</div>
		</div>
	</div>
	...
	<div class="page-cart-content" style="background-color: #F9F5F2; padding-top: 50px; padding-bottom: 80px">
	    ...
	    <div class="grid gap" style="display: flex; justify-content: center; flex-wrap: wrap; gap: 150px;">
		...
		<div class="container">
			<div class="align-items">
				<div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 30px">
					<h2 style="font-weight: 600; color: #FF7506; margin: 0;">Trending Snacks</h2>
				</div>
	...
	<div class="page-cart-content" style="margin-top: 80px; margin-bottom: 80px;">
		<div class="container">
			<div class="align-items">
				<div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 30px">
					<h2 style="font-weight: 600; color: #FF7506; margin: 0;">Popular Items</h2>
				</div>
	...
	<div class="page-cart-content" style="background-color: #F9F5F2;">
		<div class="container" style="padding-top: 25px; padding-bottom: 50px">
			<div class="align-items">
				<div class="card flat" style="padding-left: 30px; padding-right: 30px; background-color: #F9F5F2;">
	...
	<div class="page-cart-content" style="background-color: #008374; position: relative; overflow: hidden;">
	    ...
	    <div class="container" style="padding-top: 50px; padding-bottom: 50px; position: relative; z-index: 1;">
	        <div class="align-items">
	            <div class="card flat" style="padding-left: 30px; padding-right: 30px; background-color: transparent;">
